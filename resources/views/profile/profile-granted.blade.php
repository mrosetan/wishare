    ...
    <div class="panel panel-default">
      <div class="panel-body">
        ...
        <div class="wish-icons pull-right">
          ...
          &nbsp;&nbsp;
          <a href="{!! action('UserController@rewishDetails', $gr['id']) !!}"><span class="fa fa-retweet"></span></a>
          &nbsp;&nbsp;
          <a href="#" class="mb-control" data-box="#mb-deletewish{!! $gr['id'] !!}"><span class="glyphicon glyphicon-trash"></span></a>
        </div>
      </div>
      <!-- end of panel body -->
    </div>
