            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-sm-12">
                  ...
                  {!! Form::text('birthdate', ($user->birthdate == 0000-00-00 ? '1995-01-01':$user->birthdate), array('class'=>'form-control', 'data-beatpicker'=>'true', 'data-beatpicker-position'=>'['*','*']', 'data-beatpicker-module'=>'clear,icon')) !!}
                </div>
              </div>
              <br />
              <div class="row">
