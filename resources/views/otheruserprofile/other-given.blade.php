    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <div class="pull-left">
          ...
          <b>{!! $otherUser['firstname'] !!} {!! $otherUser['lastname'] !!}</b> granted <a href="{!! action('OtherUserController@profile', $gi->user['id']) !!}"><b>{!! $gi->user['firstname'] !!} {!! $gi->user['lastname'] !!}</b> ({!! $gi->user['username'] !!})</a>'s wish: <b><a href="{!! action('SoloWishController@wish', $gi['id'] ) !!}">{!! $gi['title'] !!}</a></b>
          <br />
